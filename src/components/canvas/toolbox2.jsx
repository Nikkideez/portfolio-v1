...
import { Billboard, Text, TrackballControls, PresentationControls } from '@react-three/drei'
...
function GroupRotation() {
  ...
  useFrame(({ camera }) => {
    sphereRef.current.rotation.x += 0.0025;
  ...
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [0, 0, 35], fov: 90 }}>
      ...
      <Suspense fallback={null}>
        {/* <group rotation={[50, 10.5, 10]}> */}
          {/* <Cloud count={8} radius={20} /> */}
        {/* </group> */}
        <GroupRotation />
      </Suspense>
      <TrackballControls noZoom={true} rotateSpeed={4} />
      {/* <PresentationControls rotation={} /> */}
    </Canvas>
  )
}
